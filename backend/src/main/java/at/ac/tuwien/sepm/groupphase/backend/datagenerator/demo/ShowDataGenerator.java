...
public class ShowDataGenerator implements DataGenerator {
    ...
    public void generate(){
        ...
        if(showRepository.count() > 0){
            ...
            /*
            Show show1 = Show.builder().id(1L).event(eventRepository.getOne(1L)).hall(hallRepository.getOne(1L)).ticketsSold(10000L).pricePattern(pricePattern).date(LocalDate.parse("09-10-2020", dateFormatter)).time(LocalTime.parse("10:30", timeFormatter)).description("description").build();
            Show show2 = Show.builder().id(2L).event(eventRepository.getOne(3L)).hall(hallRepository.getOne(2L)).ticketsSold(2000L).pricePattern(pricePattern).date(LocalDate.parse("15-11-2020", dateFormatter)).time(LocalTime.parse("20:30", timeFormatter)).description("description").build();
            Show show3 = Show.builder().id(3L).event(eventRepository.getOne(4L)).hall(hallRepository.getOne(3L)).ticketsSold(1500L).pricePattern(pricePattern).date(LocalDate.parse("14-08-2020", dateFormatter)).time(LocalTime.parse( "17:30", timeFormatter)).description("description").build();
            Show show4 = Show.builder().id(4L).event(eventRepository.getOne(5L)).hall(hallRepository.getOne(4L)).ticketsSold(150L).pricePattern(pricePattern).date(LocalDate.parse("07-07-2020", dateFormatter)).time(LocalTime.parse( "19:00", timeFormatter)).description("description").build();
            Show show5 = Show.builder().id(5L).event(eventRepository.getOne(6L)).hall(hallRepository.getOne(5L)).ticketsSold(200L).pricePattern(pricePattern).date(LocalDate.parse("01-01-2020", dateFormatter)).time(LocalTime.parse( "19:30", timeFormatter)).description("description").build();
            ...
            Show show7 = Show.builder().id(7L).event(eventRepository.getOne(9L)).hall(hallRepository.getOne(7L)).ticketsSold(500L).pricePattern(pricePattern).date(LocalDate.parse("19-02-2020", dateFormatter)).time(LocalTime.parse( "23:00",timeFormatter)).description("description").build();
            Show show8 = Show.builder().id(8L).event(eventRepository.getOne(10L)).hall(hallRepository.getOne(8L)).ticketsSold(400L).pricePattern(pricePattern).date(LocalDate.parse("04-04-2020", dateFormatter)).time(LocalTime.parse( "23:30",timeFormatter)).description("description").build();
            Show show9 = Show.builder().id(9L).event(eventRepository.getOne(13L)).hall(hallRepository.getOne(9L)).ticketsSold(500L).pricePattern(pricePattern).date(LocalDate.parse("22-06-2020", dateFormatter)).time(LocalTime.parse( "14:30",timeFormatter)).description("description").build();
            Show show10 = Show.builder().id(10L).event(eventRepository.getOne(14L)).hall(hallRepository.getOne(10L)).ticketsSold(500L).pricePattern(pricePattern).date(LocalDate.parse("29-12-2020", dateFormatter)).time(LocalTime.parse( "15:30",timeFormatter)).description("description").build();

            Show show11 = Show.builder().id(11L).event(eventRepository.getOne(15L)).hall(hallRepository.getOne(1L)).ticketsSold(2000L).pricePattern(pricePattern).date(LocalDate.parse("16-07-2020", dateFormatter)).time(LocalTime.parse( "10:30",timeFormatter)).description("description").build();
            Show show12 = Show.builder().id(12L).event(eventRepository.getOne(16L)).hall(hallRepository.getOne(1L)).ticketsSold(1800L).pricePattern(pricePattern).date(LocalDate.parse("04-12-2020", dateFormatter)).time(LocalTime.parse( "12:00",timeFormatter)).description("description").build();
            Show show13 = Show.builder().id(13L).event(eventRepository.getOne(19L)).hall(hallRepository.getOne(2L)).ticketsSold(1200L).pricePattern(pricePattern).date(LocalDate.parse("03-11-2020", dateFormatter)).time(LocalTime.parse( "12:30",timeFormatter)).description("description").build();
            Show show14 = Show.builder().id(14L).event(eventRepository.getOne(20L)).hall(hallRepository.getOne(3L)).ticketsSold(1400L).pricePattern(pricePattern).date(LocalDate.parse("17-02-2020", dateFormatter)).time(LocalTime.parse( "13:00",timeFormatter)).description("description").build();
            Show show15 = Show.builder().id(15L).event(eventRepository.getOne(4L)).hall(hallRepository.getOne(4L)).ticketsSold(100L).pricePattern(pricePattern).date(LocalDate.parse("23-02-2020", dateFormatter)).time(LocalTime.parse( "15:00",timeFormatter)).description("description").build();

            Show show16 = Show.builder().id(16L).event(eventRepository.getOne(5L)).hall(hallRepository.getOne(4L)).ticketsSold(200L).pricePattern(pricePattern).date(LocalDate.parse("28-07-2020", dateFormatter)).time(LocalTime.parse( "17:30",timeFormatter)).description("description").build();
            Show show17 = Show.builder().id(17L).event(eventRepository.getOne(7L)).hall(hallRepository.getOne(5L)).ticketsSold(400L).pricePattern(pricePattern).date(LocalDate.parse("30-08-2020", dateFormatter)).time(LocalTime.parse( "15:00",timeFormatter)).description("description").build();
            Show show18 = Show.builder().id(18L).event(eventRepository.getOne(16L)).hall(hallRepository.getOne(5L)).ticketsSold(100L).pricePattern(pricePattern).date(LocalDate.parse("30-03-2020", dateFormatter)).time(LocalTime.parse( "11:00",timeFormatter)).description("description").build();
            Show show19 = Show.builder().id(19L).event(eventRepository.getOne(15L)).hall(hallRepository.getOne(5L)).ticketsSold(500L).pricePattern(pricePattern).date(LocalDate.parse("11-05-2020", dateFormatter)).time(LocalTime.parse( "19:00",timeFormatter)).description("description").build();
            Show show20 = Show.builder().id(20L).event(eventRepository.getOne(16L)).hall(hallRepository.getOne(6L)).ticketsSold(500L).pricePattern(pricePattern).date(LocalDate.parse("06-01-2020", dateFormatter)).time(LocalTime.parse( "21:30",timeFormatter)).description("description").build();
            ...
            Show show46 = Show.builder().id(46L).event(eventRepository.getOne(25L)).hall(hallRepository.getOne(14L)).ticketsSold(1200L).pricePattern(pricePattern).date(LocalDate.parse("05-02-2020", dateFormatter)).time(LocalTime.parse( "21:00",timeFormatter)).description("description").build();
            Show show47 = Show.builder().id(47L).event(eventRepository.getOne(26L)).hall(hallRepository.getOne(15L)).ticketsSold(2500L).pricePattern(pricePattern).date(LocalDate.parse("19-03-2020", dateFormatter)).time(LocalTime.parse( "23:30",timeFormatter)).description("description").build();
            Show show48 = Show.builder().id(48L).event(eventRepository.getOne(29L)).hall(hallRepository.getOne(9L)).ticketsSold(1800L).pricePattern(pricePattern).date(LocalDate.parse("24-04-2020", dateFormatter)).time(LocalTime.parse( "23:30",timeFormatter)).description("description").build();
            Show show49 = Show.builder().id(49L).event(eventRepository.getOne(28L)).hall(hallRepository.getOne(10L)).ticketsSold(1100L).pricePattern(pricePattern).date(LocalDate.parse("22-08-2020", dateFormatter)).time(LocalTime.parse( "23:00",timeFormatter)).description("description").build();
            Show show50 = Show.builder().id(50L).event(eventRepository.getOne(27L)).hall(hallRepository.getOne(10L)).ticketsSold(1800L).pricePattern(pricePattern).date(LocalDate.parse("23-11-2020", dateFormatter)).time(LocalTime.parse( "18:30",timeFormatter)).description("description").build();
*/
