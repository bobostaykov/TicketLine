...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Page<UserDTO> getUsers(String username, Integer page) throws ServiceException {
        if (username == null)
    ...
    @Override
    public Page<UserDTO> getBlockedUsers(String username, Integer page) throws ServiceException{
        if (username == null)
