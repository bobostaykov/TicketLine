...
public class LocationRepositoryTest {
    ...
    private Location location1 = Location.builder().id(1L).locationName("Burgtheater").country("Austria").city("Vienna").street("NoStreet 100").postalCode("2000").description("Description").houseNr(14).build();
    private Location location2 = Location.builder().id(2L).locationName("Royal Palace").country("Bulgaria").city("Sofia").street("DummyStreet 5").postalCode("5555").description("Oww").houseNr(12).build();
    private Location location3 = Location.builder().id(3L).locationName("Steyrian Palace").country("Austria").city("Graz").street("BrodaFromAnathaMada 0").postalCode("7777").houseNr(10).build();
