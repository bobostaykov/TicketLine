...
public class ShowRepositoryTest {
    ...
    public void findShowsByStartDate(){
        Page<Show> showPage = showRepository.findAllShowsFiltered(FROMDATE_ONLY_PARAMETERS, 0);
    ...
    public void findShowsByEventName(){
        Page<Show> showPage = showRepository.findAllShowsFiltered(NAME_ONLY_PARAMETERS, 0);
    ...
    public void findShowsByStartDate_NoFittingStartDateInDatabase_givesNoResults(){
        ...
        Page<Show> showPage = showRepository.findAllShowsFiltered(PARAMETER_LATE_STARTDATE, 0);
        Assert.assertTrue(showPage.getContent().isEmpty());

    }

    @Test
    public void findOneShowAndDontFindOthers(){
        Page<Show> showPage = showRepository.findAllShowsFiltered(DETAILED_PARAMETERS, 0);
    ...
    public void findShowByMaxDate(){
        ...
        Page<Show> showPage = showRepository.findAllShowsFiltered(parameters, 0);
        Assert.assertTrue(showPage.getContent().contains(show1));
        Assert.assertEquals(1, showPage.getContent().size());
    }
    @Test
    public void findShowByMinDate(){
        ...
        showPage = showRepository.findAllShowsFiltered(parameters, 0);
        Assert.assertEquals(3, showPage.getContent().size());
        Assert.assertFalse(showPage.getContent().contains(show1));
    ...
    public void findShowByHallName(){
        ...
        Page<Show> showPage = showRepository.findAllShowsFiltered(SuccessParameters, 0);
        Assert.assertEquals(3, showPage.getContent().size());
        showPage = showRepository.findAllShowsFiltered(FailureParameters, 0);
        Assert.assertEquals(0, showPage.getContent().size());
    }
    @Test
